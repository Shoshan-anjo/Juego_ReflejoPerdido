...
def mostrar_menu():
    while True:
        ...
        titulo = titulo_fuente.render("Reflejo Perdido", True, COLOR_FIGURA)
        instruccion = fuente.render("Presiona ESPACIO para comenzar", True, COLOR_TEXTO)
        ventana.blit(titulo, ((ANCHO - titulo.get_width()) // 2, 200))
        ventana.blit(instruccion, ((ANCHO - instruccion.get_width()) // 2, 300))
        pygame.display.flip()
...
niveles = [
    ...
    {"figura_base": [(0, 0), (1, 0), (1, 1), (1, 2), (2, 2)], "jugador_pos": [0, 3], "objetivo_pos": [0, 0], "bloqueos": [("pared", 2, 1), ("espejo", 1, 3), ("espejo", 0, 1)], "reflejos": 2, "movimientos": 10},
    {"figura_base": [(0, 0), (0, 1), (1, 0), (2, 0), (2, 1)], "jugador_pos": [1, 4], "objetivo_pos": [1, 0], "bloqueos": [("pared", 2, 3), ("espejo", 0, 2)], "reflejos": 1, "movimientos": 9},
    {"figura_base": [(0, 0), (1, 0), (1, 1), (2, 0), (3, 0)], "jugador_pos": [0, 2], "objetivo_pos": [2, 1], "bloqueos": [("pared", 2, 1), ("pared", 1, 2), ("espejo", 1, 1), ("espejo", 3, 1)], "reflejos": 3, "movimientos": 12},
    {"figura_base": [(0, 0), (1, 0), (2, 0), (2, 1), (3, 1), (3, 2)], "jugador_pos": [0, 4], "objetivo_pos": [1, 0], "bloqueos": [("pared", 2, 2), ("espejo", 0, 3), ("espejo", 1, 2)], "reflejos": 2, "movimientos": 13}
]
